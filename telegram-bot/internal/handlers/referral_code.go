...
• Этот промокод предназначен только для новых пользователей без активной подписки

• При использовании вашего промокода новый пользователь получит 1 бесплатный месяц подписки

• За каждого пользователя, который использует ваш реферальный код, вам будет добавлен +1 месяц к текущей активной подписке

• Вы получите уведомление в боте каждый раз, когда кто-то использует ваш промокод`
